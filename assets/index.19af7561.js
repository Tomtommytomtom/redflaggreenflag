var ie=Object.defineProperty;var j=Object.getOwnPropertySymbols;var re=Object.prototype.hasOwnProperty,le=Object.prototype.propertyIsEnumerable;var T=(e,t,s)=>t in e?ie(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s,N=(e,t)=>{for(var s in t||(t={}))re.call(t,s)&&T(e,s,t[s]);if(j)for(var s of j(t))le.call(t,s)&&T(e,s,t[s]);return e};import{a as A,o as l,c,b as r,d as U,r as _,e as P,f as J,g,u as L,h as q,w as I,R as z,i as K,j as ce,t as he,F as Q,k as W,l as Y,n as ue,m as de,p as ye,q as fe,s as me}from"./vendor.686f0e36.js";const pe=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function s(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerpolicy&&(n.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?n.credentials="include":o.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(o){if(o.ep)return;o.ep=!0;const n=s(o);fetch(o.href,n)}};pe();const w=({a:e,b:t,c:s,svg:a,id:o})=>{const n=document.createElementNS("http://www.w3.org/2000/svg","path");return n.setAttributeNS(null,"id",o),n.setAttributeNS(null,"d",`M ${e.x} ${e.y} Q ${t.x} ${t.y} ${s.x} ${s.y}`),n.setAttributeNS(null,"style","fill:none;stroke:#000000;stroke-width:1px;opacity:0;"),a.appendChild(n),n},Z=e=>{const t=document.getElementById("svg-overlay"),s=document.createElementNS("http://www.w3.org/2000/svg","circle");s.setAttributeNS(null,"cx",0),s.setAttributeNS(null,"cy",0),s.setAttributeNS(null,"id",e),s.setAttributeNS(null,"r","5px"),s.setAttributeNS(null,"style","fill:#000000;opacity:0;"),t.appendChild(s)},E=(e,t,s)=>({x:e.x+(t.x-e.x)/2,y:e.y-s}),C=(e,t)=>({left:t.left-e.left,right:t.right-e.left,top:t.top-e.top,bottom:t.bottom-e.top}),ge=()=>{const e=document.getElementById("flag"),t=document.getElementById("outer-box").getBoundingClientRect(),s=document.getElementsByClassName("grow-bottom-container")[0].getBoundingClientRect(),a={left:0,top:0,bottom:t.bottom-t.top,right:t.right-t.left},o=C(t,s),n=a.bottom-o.bottom;e.setAttributeNS(null,"height",n)},ve=()=>{const e=document.getElementById("outer-box").getBoundingClientRect(),t=document.getElementById("0-perk").getBoundingClientRect(),s=document.getElementById("0-negative").getBoundingClientRect(),a={left:0,top:0,bottom:e.bottom-e.top,right:e.right-e.left},o=C(e,t),n=C(e,s),i=t.width;let h=Math.round((o.top-a.top)/2),f=a.top+h;h<t.height&&(h=o.top-a.top,f=a.top);const x={x:Math.round(a.left),y:Math.round(f)},m={x:Math.round(o.right-i*1/3),y:Math.round(o.top)},d={x:Math.round(n.right-i*1/3),y:Math.round(n.top)},p={x:Math.round(a.right+20),y:Math.round(d.y-80)},B=E(x,m,0),S=E(m,d,h),b=E(p,d,0),v=document.getElementById("svg-overlay");v.style.height=e.height,w({a:x,b:B,c:m,svg:v,id:"first-path"}),w({a:m,b:S,c:d,svg:v,id:"second-path"}),w({a:d,b,c:p,svg:v,id:"third-path"}),Z("ball")},we=()=>{const e=document.getElementById("svg-overlay"),t=document.getElementById("outer-box").getBoundingClientRect(),s=document.getElementsByClassName("last-negative")[0].getBoundingClientRect(),a=document.getElementById("flag").getBoundingClientRect(),o=C(t,a),n={left:0,top:0,bottom:t.bottom-t.top,right:t.right-t.left},i=C(t,s),h=4/7*t.width,f=n.bottom-i.bottom+20,x={x:n.right,y:i.bottom+20},m={x:n.right-2/5*h,y:n.bottom},d={x:n.right-4/5*h,y:n.bottom},p={x:n.right-h,y:n.bottom-5},B={x:o.left+a.width*.3,y:n.bottom-5},S={x:o.left+a.width*.2,y:n.bottom+10},b=E(x,m,0),v=E(m,d,3/4*f),R=E(d,p,1/2*f),k=E(B,S,0);w({a:x,b,c:m,svg:e,id:"fourth-path"}),w({a:m,b:v,c:d,svg:e,id:"fifth-path"}),w({a:d,b:R,c:p,svg:e,id:"sixth-path"}),w({a:p,b:p,c:B,svg:e,id:"seventh-path"}),w({a:B,b:k,c:S,svg:e,id:"eighth-path"}),Z("ball-2")},be=()=>{const e=document.getElementById("svg-overlay"),t=document.getElementById("outer-box").getBoundingClientRect(),s=document.getElementById("flag").getBoundingClientRect(),a=C(t,s),o={left:0,top:0,bottom:t.bottom-t.top,right:t.right-t.left},n=4/7*t.width,i={x:o.right-n,y:o.bottom-5},h=i.x-a.left,f={x:a.left+h/2,y:o.bottom-5};w({a:i,b:i,c:f,svg:e,id:"ninth-path"})},ke=()=>{ve(),we(),be()},u=e=>{const t=document.querySelector(e);t.style.opacity=1},M=e=>{const t=document.querySelector(e);t.style.opacity=0},X=["#first-path","#second-path","#third-path","#ball"],ee=["#fourth-path","#fifth-path","#sixth-path","#seventh-path","#eighth-path","#ball-2"],te=["#fourth-path","#fifth-path","#sixth-path","#ninth-path","#ball-2"],_e=()=>{X.forEach(M)},xe=()=>{ee.forEach(M)},Be=()=>{te.forEach(M)},Ae=()=>{X.forEach(A.remove)},Ee=()=>{ee.forEach(A.remove)},Se=()=>{te.forEach(A.remove)},G=()=>{Ae(),Ee(),Se()},D=()=>{_e(),xe(),Be()},y=(e,t,s)=>()=>{const a=A(N({targets:e,strokeDashoffset:[A.setDashoffset,0]},s)),o=A.path(e),n=A(N({targets:t,translateX:o("x"),translateY:o("y"),angle:o("angle")},s));return[a,n]},Ce=[y("#first-path","#ball",{duration:800,easing:"easeInCubic"}),y("#second-path","#ball",{duration:1200,easing:"cubicBezier(0.010, 0.25, 0.70, 0.010)"}),y("#third-path","#ball",{duration:500,easing:"easeOutCubic"})],F=async(e,t)=>{const s=[];for(let a=0;a<e.length;a+=1){const o=e[a]();s.push(...o);const n=t[a];await Promise.all(o.map(i=>i.finished)),n==null||n()}return s},Re=async(...e)=>{u("#ball"),u("#first-path");const s=[()=>u("#second-path"),()=>u("#third-path"),void 0].map((a,o)=>()=>{var n;a==null||a(),(n=e==null?void 0:e[o])==null||n.call(e)});return F(Ce,s)},$e=[y("#fourth-path","#ball-2",{duration:300,easing:"easeInQuad"}),y("#fifth-path","#ball-2",{duration:400,easing:"cubicBezier(0, 0.42, 1, 0.58)"}),y("#sixth-path","#ball-2",{duration:200,easing:"cubicBezier(0, 0.42, 1, 0.58)"}),y("#seventh-path","#ball-2",{duration:1300,easing:"cubicBezier(0.2, 0.5, 0.2, 1)"}),y("#eighth-path","#ball-2",{duration:200,easing:"easeInQuad"})],Ne=[y("#fourth-path","#ball-2",{duration:400,easing:"easeInQuad"}),y("#fifth-path","#ball-2",{duration:700,easing:"cubicBezier(0, 0.42, 1, 0.58)"}),y("#sixth-path","#ball-2",{duration:350,easing:"cubicBezier(0, 0.42, 1, 0.58)"}),y("#ninth-path","#ball-2",{duration:1e3,easing:"easeOutQuad"})],Le=async(...e)=>{u("#ball-2"),u("#fourth-path");const s=[()=>u("#fifth-path"),()=>u("#sixth-path"),()=>u("#seventh-path"),()=>u("#eighth-path"),void 0].map((a,o)=>()=>{var n;a==null||a(),(n=e==null?void 0:e[o])==null||n.call(e)});return F($e,s)},Pe=async(...e)=>{u("#ball-2"),u("#fourth-path");const s=[()=>u("#fifth-path"),()=>u("#sixth-path"),()=>u("#ninth-path"),void 0].map((a,o)=>()=>{var n;a==null||a(),(n=e==null?void 0:e[o])==null||n.call(e)});return F(Ne,s)};var $=(e,t)=>{const s=e.__vccOpts||e;for(const[a,o]of t)s[a]=o;return s};const Me={},Fe={class:"header italic"},je=r("div",null,[r("span",{class:"font-bold"},"RED"),U(" FLAGS")],-1),Te=r("div",null,[r("span",{class:"font-bold"},"GREEN"),U(" FLAGS")],-1),qe=[je,Te];function Ie(e,t){return l(),c("div",Fe,qe)}var ze=$(Me,[["render",Ie]]);const Ge=["GAME","MENU"],De=_(Ge[0]),ne=P(()=>De.value),He=P(()=>ne.value==="GAME");P(()=>ne.value==="MENU");const Oe={},Ve={id:"flag",height:"1",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 172.2 276.22"},Ue=J('<defs></defs><ellipse class="cls-1" cx="33.5" cy="266.84" rx="33.5" ry="9.38"></ellipse><rect class="cls-2" x="29.5" y="6.72" width="7" height="266"></rect><rect class="cls-3" x="29.5" y="6.72" width="7" height="266"></rect><rect class="cls-3" x="29.5" y="6.72" width="7" height="266"></rect><path class="cls-4" d="M632.9,1637c-2.09,8.93-6.94,23.46-19.28,35.6-19.39,19.08-46.56,21.73-51.92,22.25-19.72,1.93-34.26-3.15-54.88,6.68a72.39,72.39,0,0,0-7.42,4.08v-69.33c8.75-3.88,21.81-8,36.34-5.21,14.8,2.82,21,10.82,31.89,15.57C579.92,1652,599.88,1654,632.9,1637Z" transform="translate(-462.9 -1628.69)"></path>',6),Je=[Ue];function Ke(e,t){return l(),c("svg",Ve,Je)}var Qe=$(Oe,[["render",Ke]]);const We={},Ye={id:"Ebene_1","data-name":"Ebene 1",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 49.16 49.16"},Ze=J('<defs></defs><circle class="cls-1" cx="24.58" cy="24.58" r="19"></circle><line class="cls-2" x1="24.58" y1="24.58" x2="24.58" y2="24.58"></line><line class="cls-3" x1="24.58" x2="24.58" y2="49.16"></line><line class="cls-3" x1="49.16" y1="24.58" y2="24.58"></line><line class="cls-3" x1="41.96" y1="7.2" x2="7.2" y2="41.96"></line><line class="cls-3" x1="7.2" y1="7.2" x2="41.96" y2="41.96"></line><circle class="cls-4" cx="24.58" cy="24.58" r="17.23"></circle>',8),Xe=[Ze];function et(e,t){return l(),c("svg",Ye,Xe)}var tt=$(We,[["render",et]]);const nt={class:"footer flex items-end justify-between italic"},st=r("button",null,"Back",-1),at={setup(e){return(t,s)=>(l(),c("div",nt,[g(Qe,{style:{"margin-bottom":"-0.75em","margin-left":"1.5em"}}),L(He)?(l(),q(L(z),{key:0,to:"/menu"},{default:I(()=>[g(tt,{style:{width:"2em"}})]),_:1})):(l(),q(L(z),{key:1,to:"/"},{default:I(()=>[st]),_:1}))]))}};const ot={class:"cont h-full p-2"},it=r("svg",{id:"svg-overlay",class:"svg-overlay absolute"},null,-1),rt={id:"outer-box",class:"outer-box relative h-full w-full p-2"},lt={class:"grow-bottom-container"},ct={setup(e){return K(()=>{ge()}),(t,s)=>{const a=ce("router-view");return l(),c("div",ot,[it,r("div",rt,[g(ze),r("div",lt,[g(a)]),g(at,{class:"mt-16"})])])}}};var ht=`Has a magic bag that contains unlimited cheese
always defends you
...
volunteers for refugee camp`,ut=`50 Shades of Grey is the only book they've read
Body type: Dumpster
...
you are allergic to them`;const H=e=>e[Math.floor(Math.random()*e.length)],dt=ht.split(`
`),yt=ut.split(`
`),se=(e,t)=>{const s=Array.from([...Array(t).keys()]);return s.map(()=>{let a=H(e);for(;s.includes(a);)a=H(e);return a})},ft=e=>se(dt,e),mt=e=>se(yt,e);const pt={class:"box flex w-full items-center italic"},ae={props:{text:String,visible:Boolean},setup(e){const t=e;return(s,a)=>(l(),c("div",pt,he(e.visible?t.text:""),1))}},gt=r("span",{class:"italic"},"YOUR DATE",-1),vt={key:0,class:"italic"},O={props:{perks:Array,visible:Array},setup(e){const t=e;return(s,a)=>(l(),c("div",null,[gt,(l(!0),c(Q,null,W(e.perks,(o,n)=>(l(),c("div",{key:n},[g(ae,{text:o,id:`${n}-perk`,visible:t.visible[n]},null,8,["text","id","visible"]),n!==e.perks.length-1?(l(),c("span",vt,"AND")):Y("",!0)]))),128))]))}},wt=r("span",{class:"italic"},"(BUT)",-1),bt={key:0,class:"italic"},kt={props:{negatives:Array,visible:Array},setup(e){const t=e;return(s,a)=>(l(),c("div",null,[wt,(l(!0),c(Q,null,W(e.negatives,(o,n)=>(l(),c("div",{key:n},[g(ae,{class:ue(["black-box",{"last-negative":n===e.negatives.length-1}]),text:o,id:`${n}-negative`,visible:t.visible[n]},null,8,["text","class","id","visible"]),n!==e.negatives.length-1?(l(),c("span",bt,"AND")):Y("",!0)]))),128))]))}},_t={class:"flex"},xt={class:"flex w-1/2 flex-col pr-1"},Bt=r("span",{style:{visibility:"hidden"}},"AND",-1),At={class:"flex"},Et=["disabled"],St=["disabled"],Ct={class:"w-1/2 pl-1"},V={setup(e){const t=_(!0),s=_([]),a=_([]),o=_(2),n=_(1),i=_([]),h=_([]),f=()=>{s.value=ft(o.value),a.value=mt(n.value),i.value=Array(o.value).fill(!1),h.value=Array(n.value).fill(!1)};f();const x=()=>{h.value=h.value.map(()=>!0)},m=()=>{i.value=i.value.map(()=>!0)},d=()=>{Re(m,x,()=>{t.value=!1})},p=()=>{G(),D(),v()},B=()=>{t.value=!0;const k=[];k[3]=()=>{p(),f()},Pe(...k)},S=()=>{t.value=!0;const k=[];k[4]=()=>{p(),f()},Le(...k)},b=()=>{d(),R()},v=()=>{window.addEventListener("click",b),window.addEventListener("touchstart",b)},R=()=>{window.removeEventListener("click",b),window.removeEventListener("touchstart",b)};return K(()=>{ke()}),de(()=>{G(),D(),R()}),v(),(k,It)=>(l(),c("div",_t,[r("div",xt,[g(O,{perks:s.value,visible:i.value},null,8,["perks","visible"]),Bt,r("div",At,[r("button",{onClick:S,disabled:t.value,class:"box mr-1 grow"}," DATE ",8,Et),r("button",{onClick:B,disabled:t.value,class:"black-box grow"}," (NEXT) ",8,St)])]),r("div",Ct,[g(O,{style:{visibility:"hidden"},visible:i.value,perks:s.value},null,8,["visible","perks"]),g(kt,{negatives:a.value,visible:h.value},null,8,["negatives","visible"])])]))}},Rt={},$t={class:"flex"},Nt=r("div",null,"Anzahl",-1),Lt=r("div",null,"Add new",-1),Pt=r("div",null,"History",-1),Mt=[Nt,Lt,Pt];function Ft(e,t){return l(),c("div",$t,Mt)}var jt=$(Rt,[["render",Ft]]);const Tt=[{path:"/",component:V,meta:{title:"Game"}},{path:"/menu",component:jt},{path:"/:path(.*)",component:V}],oe=ye(ct),qt=fe({history:me(),routes:Tt});oe.use(qt);oe.mount("#app");
