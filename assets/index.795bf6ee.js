import{r as j,o as r,c as l,a as i,b as h,t as C,F as $,d as A,e as N,f as m,g as u,h as g,i as M,j as P,k as D,l as L}from"./vendor.960219fb.js";const R=function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function o(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerpolicy&&(s.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?s.credentials="include":t.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(t){if(t.ep)return;t.ep=!0;const s=o(t);fetch(t.href,s)}};R();var _=(e,n)=>{const o=e.__vccOpts||e;for(const[a,t]of n)o[a]=t;return o};const F={},z={class:"h-full"},O={class:"h-full"};function T(e,n){const o=j("router-view");return r(),l("div",z,[i("main",O,[h(o)])])}var H=_(F,[["render",T]]),I=`is fiercely loyal
...
Hhas a magic bag that contains unlimited cheese
...
is in a fried group called "_____"
never stops talking
...
swears you look exactly like their siste but says "that's a good thing"
tinders during sex
...
they thinks they're smarter than you
as long as you date them you can only eat food off the dollar menu
can't stand animals
plays loud music outside
`;const k=e=>e[Math.floor(Math.random()*e.length)],G=I.split(`
`),Y=q.split(`
`),S=(e,n)=>{const o=Array.from([...Array(n).keys()]);return console.log(o),o.map(()=>{let a=k(e);for(;o.includes(a);)a=k(e);return console.log(a),a})},V=e=>S(G,e),K=e=>S(Y,e);const Q={class:"box italic flex items-center w-full"},B={props:{text:String,visible:Boolean},setup(e){const n=e;return(o,a)=>(r(),l("div",Q,C(e.visible?n.text:""),1))}},W=i("span",{class:"italic"},"YOUR DATE",-1),X={key:0,class:"italic"},b={props:{perks:Array,visible:Array},setup(e){const n=e;return(o,a)=>(r(),l("div",null,[W,(r(!0),l($,null,A(e.perks,(t,s)=>(r(),l("div",null,[h(B,{text:t,id:`${s}-perk`,visible:n.visible[s]},null,8,["text","id","visible"]),s!==e.perks.length-1?(r(),l("span",X,"AND")):N("",!0)]))),256))]))}},U=i("span",{class:"italic"},"(BUT)",-1),J={key:0,class:"italic"},Z={props:{negatives:Array,visible:Array},setup(e){const n=e;return(o,a)=>(r(),l("div",null,[U,(r(!0),l($,null,A(e.negatives,(t,s)=>(r(),l("div",null,[h(B,{text:t,id:`${s}-negative`,visible:n.visible[s]},null,8,["text","id","visible"]),s!==e.negatives.length-1?(r(),l("span",J,"AND")):N("",!0)]))),256))]))}};const ee={},ne={class:"header italic"},te=i("div",null,[i("span",{class:"font-bold"},"RED"),m(" FLAGS")],-1),se=i("div",null,[i("span",{class:"font-bold"},"GREEN"),m(" FLAGS")],-1),oe=[te,se];function ae(e,n){return r(),l("div",ne,oe)}var ie=_(ee,[["render",ae]]);const re={},le={class:"footer italic flex"},ue=i("div",{class:"grow"},[i("div",null,[i("span",{class:"font-bold"},"RED"),m(" FLAGS")]),i("div",null,[i("span",{class:"font-bold"},"GREEN"),m(" FLAGS")])],-1),ce=i("div",null,"icon",-1),he=[ue,ce];function de(e,n){return r(),l("div",le,he)}var ye=_(re,[["render",de]]);const pe=()=>{const e=document.getElementById("outer-box").getBoundingClientRect(),n=document.getElementById("0-perk").getBoundingClientRect(),o=document.getElementById("0-negative").getBoundingClientRect();console.log(n),console.log(o);const a={x:Math.round(n.right-50),y:Math.round(n.top)},t={x:Math.round(o.right-80),y:Math.round(o.top)},s={x:Math.round(e.left),y:Math.round(a.y-120)},c={x:Math.round(e.right),y:Math.round(t.y-80)};console.log(a),console.log(t);const v=document.getElementById("svg-overlay"),p=document.createElementNS("http://www.w3.org/2000/svg","path");p.setAttributeNS(null,"id","first-path"),p.setAttributeNS(null,"d",`M ${s.x} ${s.y} Q ${s.x+100} ${s.y} ${a.x} ${a.y}`),p.setAttributeNS(null,"style","fill:none;stroke:#000000;stroke-width:1px;opacity:0;"),v.appendChild(p);const f=document.createElementNS("http://www.w3.org/2000/svg","path");f.setAttributeNS(null,"id","second-path"),f.setAttributeNS(null,"d",`M ${a.x} ${a.y} Q ${a.x+100} ${a.y-200} ${t.x} ${t.y}`),f.setAttributeNS(null,"style","fill:none;stroke:#000000;stroke-width:1px;opacity:0;"),v.appendChild(f);const d=document.createElementNS("http://www.w3.org/2000/svg","path");d.setAttributeNS(null,"id","third-path"),d.setAttributeNS(null,"d",`M ${t.x} ${t.y} Q ${t.x+40} ${t.y-100} ${c.x} ${c.y}`),d.setAttributeNS(null,"style","fill:none;stroke:#000000;stroke-width:1px;opacity:0;"),v.appendChild(d);const y=document.createElementNS("http://www.w3.org/2000/svg","circle");y.setAttributeNS(null,"cx",0),y.setAttributeNS(null,"cy",0),y.setAttributeNS(null,"class","ball"),y.setAttributeNS(null,"r","5px"),y.setAttributeNS(null,"style","fill:#000000;opacity:0;"),v.appendChild(y)},w=e=>{const n=document.querySelector(e);console.log(n),n.style.opacity=1},fe=e=>{w(".ball"),u({targets:"#first-path",strokeDashoffset:[u.setDashoffset,0],easing:"easeInCubic",complete:e,duration:800});const n=u.path("#first-path");console.log(n("x")),u({targets:".ball",translateX:n("x"),translateY:n("y"),easing:"easeInCubic",angle:n("angle"),duration:800}),w("#first-path")},ge=e=>{const n="cubicBezier(0.010, 0.25, 0.70, 0.010)";u({targets:"#second-path",strokeDashoffset:[u.setDashoffset,0],easing:n,complete:e,duration:1e3,delay:function(a,t){return t*250}});const o=u.path("#second-path");console.log(o("x")),u({targets:".ball",translateX:o("x"),translateY:o("y"),easing:n,angle:o("angle"),duration:1e3}),w("#second-path")},ve=()=>{const e="easeOutCubic";u({targets:"#third-path",strokeDashoffset:[u.setDashoffset,0],easing:e,duration:500,delay:function(o,a){return a*250}});const n=u.path("#third-path");console.log(n("x")),u({targets:".ball",translateX:n("x"),translateY:n("y"),easing:e,angle:n("angle"),duration:400}),w("#third-path")};const me={class:"h-full p-2"},we={id:"outer-box",class:"outer-box w-full p-2"},_e={class:"grow-bottom-container"},ke={class:"flex inner-box"},be={class:"w-1/2"},x={setup(e){const n=g([]),o=g([]),a=g(1),t=g(2),s=g([]),c=g([]);(()=>{o.value=V(t.value),n.value=K(a.value),s.value=Array(t.value).fill(!1),c.value=Array(a.value).fill(!1)})();const p=()=>{c.value=c.value.map(()=>!0),ve()},f=()=>{s.value=s.value.map(()=>!0),ge(p)},d=()=>{fe(f)};return window.addEventListener("click",d),window.addEventListener("touchstart",d),M(()=>{pe()}),(y,Ae)=>(r(),l("div",me,[i("div",we,[h(ie),i("div",_e,[i("div",ke,[h(b,{class:"w-1/2",perks:o.value,visible:s.value},null,8,["perks","visible"]),i("div",be,[h(b,{style:{visibility:"hidden"},visible:s.value,perks:o.value},null,8,["visible","perks"]),h(Z,{negatives:n.value,visible:c.value},null,8,["negatives","visible"])])])]),h(ye,{class:"mt-16"})])]))}},xe=[{path:"/",component:x,meta:{title:"Home"}},{path:"/:path(.*)",component:x}],E=P(H),$e=D({history:L(),routes:xe});E.use($e);E.mount("#app");
